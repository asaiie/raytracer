...
impl Index<usize> for Vec3 { // vec3[i]
    type Output = f64;
...
impl SubAssign for Vec3 { // vec3 -= vec3
...
impl Mul<Vec3> for Vec3 { // vec3 * vec3
    type Output = Vec3;
...
impl Mul<f64> for Vec3 { // vec3 * f64
    type Output = Vec3;
...
impl Div<f64> for Vec3 { // vec3 / f64
    type Output = Vec3;
